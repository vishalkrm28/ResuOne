...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "p", text: "This is exactly the problem ParsePilot solves. It extracts every meaningful keyword from the job description, compares it against your CV, and rewrites your experience bullets to include the missing terms naturally — without inventing experience you don't have." },
      { type: "cta" },
      ...
      { type: "ul", items: [
        ...
        "Or — use ParsePilot to do all of this in 60 seconds.",
      ]},
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "The good news: all of these mistakes are fixable. ParsePilot identifies which ones apply to your CV and fixes them in under 60 seconds." },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "ParsePilot rewrites your CV summary for each application based on the job description, so it speaks directly to what the recruiter is looking for." },
    ],
  },
];
