...
export default function Dashboard() {
  ...
  // Filter out any bulk-linked entries (only standalone applications shown here)
  ...
  const feed = [...standaloneApps].sort(
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
            ...
            {feed.map((app, i) => (
              ...
              >
                <AppCard
                  ...
                  isDeleting={deleteMutation.isPending && confirmDeleteId === app.id}
          ...
          <p className="text-xs text-center text-muted-foreground/60 pt-2">
            {feed.length} application{feed.length !== 1 ? "s" : ""}
          </p>
        </div>
      )}
    </AppLayout>
